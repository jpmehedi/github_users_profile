...
UserRepoModel userRepoModelFromJson(String str) => UserRepoModel.fromJson(json.decode(str));

String userRepoModelToJson(UserRepoModel data) => json.encode(data.toJson());
